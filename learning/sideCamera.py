# this is almost same as trace.py. I just add find_centre function to test whether we 
# can use function to find the ball. The result is we can, but the run time is too long.
# So we need to think a better idea to find ball in image.
...
while(1):
    ...
    # to find the ball in mask1.
    ball.find_centre(mask1)
    # for element in ball.centre:
        # print element
    ...
    cv2.imwrite('outPut/test2.png', mask1)
